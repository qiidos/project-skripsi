    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-navbar fixed-top shadow">
        <div class="container-fluid">
            <div class="navbar-brand">
                ...
                <a href="/daftar_siswa" class="text-light navbar-brand"><strong>SITALANG</strong></a>
            </div>
            <div class="navbar-nav me-auto mb-2 mb-lg-0 d-flex">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" style="position: absolute; transform: translate3d(-70px, 37px, 0px); top: 0px; left: 0px; will-change: transform;" x-placement="bottom-start" aria-labelledby="navbarDropdown">
            ...
            <div class="container-fluid">
                <ul class="components pl-4 pt-3" style="list-style-type: none;">
                    ...
                    <li style="list-style-type: none;">
                        <a href="/daftar_siswa" style="text-decoration: none;" class="list"><i class="fas fa-user-friends" style="margin-right: 10px;"></i>Daftar Siswa</a>
                    </li>
                    <li style="list-style-type: none;">
                        <a href="/kelola_siswa" style="text-decoration: none;" class="list"><i class="fas fa-users-cog" style="margin-right: 10px;"></i>Kelola Siswa</a>
                    </li>
                    </li>
                </ul>
            </div>
